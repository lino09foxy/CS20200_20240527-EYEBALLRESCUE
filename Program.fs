...
let rec start () =
  ...
  Console.WriteLine ("카이스트에서 열심히 눈알들과 공생하던 김눈알! 어느 날, 정체불명의 헌터가 나타나 눈알들을 잡아 병 속에 가두고 던전 안에 가둬 버렸다. 붙잡힌 눈알들을 구하기 위해 던전에 잠입한 김눈알! 숨겨진 함정들로 가득한 던전 속에서 김눈알은 무사히 눈알들을 구해낼 수 있을까?")
